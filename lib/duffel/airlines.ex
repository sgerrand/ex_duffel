defmodule Duffel.Airlines do
  @moduledoc """
  Look up airline reference data.

  See the [Duffel documentation](https://duffel.com/docs/api/v2/airlines).
  """
  ...
  @doc """
  Lazily streams all airlines across pages.
