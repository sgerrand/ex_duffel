defmodule Duffel.Aircraft do
  @moduledoc """
  Look up aircraft reference data.

  See the [Duffel documentation](https://duffel.com/docs/api/v2/aircraft).
  """
  ...
  @doc """
  Lazily streams all aircraft across pages.
